...
- 管理员查看总览、新建、启停、重置教师和学生账号
- 教师登录
- 班级管理
- 班级详情中的学生管理与批量导入
- 班级详情中的项目创建与分配发布
- 项目详情中的分析结果、学生实时进度与提示查看
